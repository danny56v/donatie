        ...
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-12 lg:px-8">
          <nav aria-label="Footer" className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12">
            {navigation.main.map((item) => (
              <div key={item.name} className="pb-6">
                <a href={item.href} className="text-sm leading-6 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100">
                  {item.name}
                </a>
              </div>
            ))}
          ...
          <div className="mt-10 flex justify-center space-x-10">
            {/* {navigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-zinc-400 hover:text-zinc-500 hover:dark:text-zinc-100">
          ...
          <p className="mt-10 text-center text-xs leading-5 text-zinc-500">
            &copy; 2025 Toate drepturile rezervate. <br />
          </p>
        </div>
      </footer>
    )
